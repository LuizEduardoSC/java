...
public class Operadores {
	...
	public static void main(String[] args) {
		...
		System.out.println("A soma das variaveis número1 e número2 é igual a: " +( numero1 + numero2));
		
		System.out.println("A soma das variaveivalor1 e valor2 é igual a: " +( valor1 + valor2));
